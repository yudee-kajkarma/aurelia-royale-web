          ...
          <nav className="hidden lg:flex items-center gap-9 text-[0.78rem] font-semibold uppercase tracking-[0.22em] text-gold">
            {primaryNavLinks.map((link) => {
              ...
              return (
                <div
                  key={link.href}
                  onMouseEnter={isShop ? openShopDropdownNow : undefined}
                  onMouseLeave={isShop ? scheduleCloseShopDropdown : undefined}
                >
                  <Link
                    href={link.href}
        ...
        <AnimatePresence>
          {openShopDropdown ? (
            <motion.div
              ...
              animate="visible"
              exit="exit"
              variants={reduceMotion ? undefined : shopDropdownVariants}
              ...
              <div className="bg-[#f5efe3] max-w-7xl mx-auto text-deep shadow-[0_24px_50px_rgba(0,0,0,0.18)]">
                <div className="mx-auto max-w-7xl px-8 py-10 lg:px-12">
                  ...
                  <motion.div
                    ...
                    variants={reduceMotion ? undefined : shopCardGridVariants}
