        ...
        >
            ...
            >
                {compact ? (
                    ...
                    <span className="display-font text-sm tracking-[0.3em] text-deep/45">
                        {category}
                    </span>
                ) : null}
                {showAddToCart ? (
            ...
            <div className={compact ? "px-4 pt-4" : ""}>
                <p className="relative z-0 text-center text-md font-semibold text-deep/85 ">
                    {name}
                </p>
                {compact && category ? (
                    <p className="relative z-0 mt-1 text-center text-xs uppercase tracking-[0.12em] text-deep/45">
                        {category}
                    </p>
                ) : null}
                {description ? (
                    <p className="relative z-0 text-center text-sm text-deep/60">
                        {description}
                    </p>
                ) : null}
                {/* <DiscountedPrice
