  ...
  return (
    <AuthGuard allowedRoles={["ADMIN"]}>
      <main className="mx-auto min-h-[70vh] w-full max-w-6xl px-6 py-16 sm:px-8">
        <section className="overflow-hidden rounded-[30px] border border-[var(--foreground)]/10 bg-[linear-gradient(180deg,#0a211a_0%,#092a21_55%,#0f382f_100%)] p-8 text-white shadow-[0_24px_80px_rgba(3,27,22,0.18)] sm:p-10">
          <div className="max-w-3xl">
            <p className="text-xs uppercase tracking-[0.26em] text-[var(--gold)]">{eyebrow}</p>
          ...
          <div className="mt-8 flex flex-col gap-4 rounded-[24px] border border-white/10 bg-white/6 p-6 sm:flex-row sm:items-center sm:justify-between">
            ...
            <Link
              href="/admin/products"
              className="inline-flex items-center justify-center rounded-full bg-[var(--gold)] px-6 py-3 text-sm font-extrabold text-[#17120a] transition hover:bg-[#b89428]"
            >
              Back To Products
            </Link>
          </div>
