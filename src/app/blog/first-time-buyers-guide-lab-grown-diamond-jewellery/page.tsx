...
export const metadataEn: Metadata = {
  title: "First Time Buyers Guide Lab Grown Diamond Jewellery",
  description: "First Time Buyers Guide Lab Grown Diamond Jewellery",
  alternates: {
...
export const metadataEs: Metadata = {
  title: "Guía para compradores por primera vez Joyería con diamantes cultivados en laboratorio",
  description: "Guía para compradores por primera vez Joyería con diamantes cultivados en laboratorio - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/first-time-buyers-guide-lab-grown-diamond-jewellery/",
  },
};

export const metadataFr: Metadata = {
  title: "Guide des premiers acheteurs Bijoux en diamants cultivés en laboratoire",
  description: "Guide des premiers acheteurs Bijoux en diamants cultivés en laboratoire - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/first-time-buyers-guide-lab-grown-diamond-jewellery/",
  },
};
...
export const metadataNl: Metadata = {
  title: "Gids voor eerste kopers Lab Grown Diamond Jewelry",
  description: "Gids voor eerste kopers Lab Grown Diamond Jewelry - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/first-time-buyers-guide-lab-grown-diamond-jewellery/",
  },
};
...
export const metadataDe: Metadata = {
  title: "Erstkäufer-Leitfaden für im Labor gezüchteten Diamantschmuck",
  description: "Erstkäufer-Leitfaden für im Labor gezüchteten Diamantschmuck - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/first-time-buyers-guide-lab-grown-diamond-jewellery/",
  },
};
...
export const metadataIt: Metadata = {
  title: "Guida per chi acquista per la prima volta gioielli con diamanti creati in laboratorio",
  description: "Inizia il tuo percorso di acquisto con fiducia. Questa guida copre le basi dei diamanti coltivati ​​in laboratorio, delle montature, dei metalli e del budget. - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/it/blog/first-time-buyers-guide-lab-grown-diamond-jewellery/",
  },
};
...
export default async function Page({ searchParams }: { searchParams: Promise<{ locale?: string }> }) {
  ...
  const localeData = getBlogDataByLocale("first-time-buyers-guide-lab-grown-diamond-jewellery", locale);
