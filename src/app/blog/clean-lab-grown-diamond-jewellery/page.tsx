  ...
  "@graph": [
    ...
    },
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "How to Clean Lab-Grown Diamond Jewellery at Home", "item": "https://www.aureliaroyale.com/blog/clean-lab-grown-diamond-jewellery/" }
      ]
    },
    {
      "@type": "FAQPage",
...
export default function Page() {
  return (
    <main className="min-h-screen bg-background text-foreground font-sans overflow-x-clip">
      ...
      <RelatedArticles currentSlug="clean-lab-grown-diamond-jewellery" />
      <NewsletterSection />
    </main>
  );
}
