...
export const metadataEn: Metadata = {
  title: "How Should Diamond Bracelet Fit",
  description: "How Should Diamond Bracelet Fit",
  alternates: {
...
export const metadataEs: Metadata = {
  title: "¿Cómo debe encajar la pulsera de diamantes?",
  description: "¿Cómo debe encajar la pulsera de diamantes? - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/how-should-diamond-bracelet-fit/",
  },
};

export const metadataFr: Metadata = {
  title: "Comment le bracelet en diamant devrait-il s'adapter",
  description: "Comment le bracelet en diamant devrait-il s'adapter - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/how-should-diamond-bracelet-fit/",
  },
};
...
export const metadataNl: Metadata = {
  title: "Hoe moet een diamanten armband passen",
  description: "Hoe moet een diamanten armband passen - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/how-should-diamond-bracelet-fit/",
  },
};
...
export const metadataDe: Metadata = {
  title: "Wie sollte ein Diamantarmband passen?",
  description: "Wie sollte ein Diamantarmband passen? - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/how-should-diamond-bracelet-fit/",
  },
};
...
export const metadataIt: Metadata = {
  title: "Come dovrebbe apparire un braccialetto di diamanti? Guida alla regolazione",
  description: "Trova la vestibilità comoda per il tuo bracciale tennis o rigido. Impara a misurare lo spazio in modo che non sia né troppo largo né troppo stretto. - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/it/blog/how-should-diamond-bracelet-fit/",
  },
};
...
export async function generateMetadata({ searchParams }: { searchParams: Promise<{ locale?: string }> }): Promise<Metadata> {
  ...
  const localeData = getBlogDataByLocale("how-should-diamond-bracelet-fit", locale);
...
export default async function HowShouldDiamondBraceletFitPage({ searchParams }: { searchParams: Promise<{ locale?: string }> }) {
  const resolvedSearchParams = await searchParams;
  const locale = resolvedSearchParams.locale ?? "en";
  const localeData = getBlogDataByLocale("how-should-diamond-bracelet-fit", locale);
  const sections = localeData && localeData.length > 0 ? localeData : articleSections;
