...
export const metadataEn: Metadata = {
  title: "How To Choose Lab Grown Diamond Jewellery Set",
  description: "How To Choose Lab Grown Diamond Jewellery Set",
  alternates: {
...
export const metadataEs: Metadata = {
  title: "Cómo elegir un juego de joyas con diamantes cultivados en laboratorio",
  description: "Cómo elegir un juego de joyas con diamantes cultivados en laboratorio - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/how-to-choose-lab-grown-diamond-jewellery-set/",
  },
};

export const metadataFr: Metadata = {
  title: "Comment choisir une parure de bijoux en diamants cultivés en laboratoire",
  description: "Comment choisir une parure de bijoux en diamants cultivés en laboratoire - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/how-to-choose-lab-grown-diamond-jewellery-set/",
  },
};
...
export const metadataNl: Metadata = {
  title: "Hoe u een Lab Grown diamanten sieradenset kiest",
  description: "Hoe u een Lab Grown diamanten sieradenset kiest - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/how-to-choose-lab-grown-diamond-jewellery-set/",
  },
};
...
export const metadataDe: Metadata = {
  title: "So wählen Sie ein Schmuckset mit im Labor gezüchteten Diamanten aus",
  description: "So wählen Sie ein Schmuckset mit im Labor gezüchteten Diamanten aus - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/how-to-choose-lab-grown-diamond-jewellery-set/",
  },
};
...
export const metadataIt: Metadata = {
  title: "Come scegliere un set di gioielli con diamanti creato in laboratorio",
  description: "Crea un look coordinato ed elegante. Impara come abbinare orecchini, collane e anelli con diamanti coltivati in laboratorio per le occasioni speciali. - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/it/blog/how-to-choose-lab-grown-diamond-jewellery-set/",
  },
};
...
export default async function Page({ searchParams }: { searchParams: Promise<{ locale?: string }> }) {
  ...
  const localeData = getBlogDataByLocale("how-to-choose-lab-grown-diamond-jewellery-set", locale);
