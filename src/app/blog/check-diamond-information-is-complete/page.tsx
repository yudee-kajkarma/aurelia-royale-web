...
export const metadataEn: Metadata = {
  title: "Check Diamond Information Is Complete",
  description: "Check Diamond Information Is Complete",
  alternates: {
...
export const metadataEs: Metadata = {
  title: "Verifique que la información del diamante esté completa",
  description: "Verifique que la información del diamante esté completa - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/check-diamond-information-is-complete/",
  },
};

export const metadataFr: Metadata = {
  title: "Vérifiez que les informations sur le diamant sont complètes",
  description: "Vérifiez que les informations sur le diamant sont complètes - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/check-diamond-information-is-complete/",
  },
};
...
export const metadataNl: Metadata = {
  title: "Controleer of de diamantinformatie compleet is",
  description: "Controleer of de diamantinformatie compleet is - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/check-diamond-information-is-complete/",
  },
};
...
export const metadataDe: Metadata = {
  title: "Überprüfen Sie, ob die Diamantinformationen vollständig sind",
  description: "Überprüfen Sie, ob die Diamantinformationen vollständig sind - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/check-diamond-information-is-complete/",
  },
};
...
export const metadataIt: Metadata = {
  title: "Come verificare che le informazioni sul diamante siano complete",
  description: "Evita sorprese quando acquisti online. Assicurati che il venditore fornisca le 4 C, le dimensioni, il certificato, le politiche di restituzione e le informazioni sul metallo. - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/it/blog/check-diamond-information-is-complete/",
  },
};
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        rows: [
          ["Required", "Neinded to identify or evaluate this product", "Laboratory-grown origin and total carat-weight scope"],
...
export default async function Page({ searchParams }: { searchParams: Promise<{ locale?: string }> }) {
  ...
  const localeData = getBlogDataByLocale("check-diamond-information-is-complete", locale);
