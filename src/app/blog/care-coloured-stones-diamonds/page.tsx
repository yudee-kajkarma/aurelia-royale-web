...
export const metadataEn: Metadata = {
  title: "Care Coloured Stones Diamonds",
  description: "Care Coloured Stones Diamonds",
  alternates: {
...
export const metadataEs: Metadata = {
  title: "Cuidados Piedras de Colores Diamantes",
  description: "Cuidados Piedras de Colores Diamantes - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/care-coloured-stones-diamonds/",
  },
};

export const metadataFr: Metadata = {
  title: "Entretien Pierres de Couleur Diamants",
  description: "Entretien Pierres de Couleur Diamants - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/care-coloured-stones-diamonds/",
  },
};
...
export const metadataNl: Metadata = {
  title: "Zorg voor gekleurde stenen diamanten",
  description: "Zorg voor gekleurde stenen diamanten - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/care-coloured-stones-diamonds/",
  },
};
...
export const metadataDe: Metadata = {
  title: "Pflege Farbsteine ​​Diamanten",
  description: "Pflege Farbsteine ​​Diamanten - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/care-coloured-stones-diamonds/",
  },
};
...
export const metadataIt: Metadata = {
  title: "Cura dei gioielli con pietre colorate e diamanti",
  description: "Scopri come pulire e conservare gioielli che combinano diamanti con pietre preziose colorate e come proteggerli da sostanze chimiche e calore. - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/it/blog/care-coloured-stones-diamonds/",
  },
};
...
export default async function Page({ searchParams }: { searchParams: Promise<{ locale?: string }> }) {
  ...
  const localeData = getBlogDataByLocale("care-coloured-stones-diamonds", locale);
