...
export const metadataEn: Metadata = {
  title: "Check Jewellery Product Dimensions Weight",
  description: "Check Jewellery Product Dimensions Weight",
  alternates: {
...
export const metadataEs: Metadata = {
  title: "Comprobar joyería Dimensiones del producto Peso",
  description: "Comprobar joyería Dimensiones del producto Peso - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/check-jewellery-product-dimensions-weight/",
  },
};

export const metadataFr: Metadata = {
  title: "Vérifier les dimensions du produit et le poids du bijou",
  description: "Vérifier les dimensions du produit et le poids du bijou - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/check-jewellery-product-dimensions-weight/",
  },
};
...
export const metadataNl: Metadata = {
  title: "Controleer sieraden Productafmetingen Gewicht",
  description: "Controleer sieraden Productafmetingen Gewicht - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/check-jewellery-product-dimensions-weight/",
  },
};
...
export const metadataDe: Metadata = {
  title: "Überprüfen Sie die Abmessungen und das Gewicht des Schmuckprodukts",
  description: "Überprüfen Sie die Abmessungen und das Gewicht des Schmuckprodukts - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/check-jewellery-product-dimensions-weight/",
  },
};
...
export const metadataIt: Metadata = {
  title: "Come controllare le dimensioni e il peso dei gioielli online",
  description: "Impara a interpretare le misure del prodotto, l'impostazione dell'altezza, lo spessore della fascia e il peso del metallo per visualizzare la dimensione effettiva dei tuoi gioielli prima dell'acquisto. - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/it/blog/check-jewellery-product-dimensions-weight/",
  },
};
...
export async function generateMetadata({ searchParams }: { searchParams: Promise<{ locale?: string }> }): Promise<Metadata> {
  ...
  const localeData = getBlogDataByLocale("check-jewellery-product-dimensions-weight", locale);
...
export default async function CheckJewelleryDimensionsWeightPage({ searchParams }: { searchParams: Promise<{ locale?: string }> }) {
  const resolvedSearchParams = await searchParams;
  const locale = resolvedSearchParams.locale ?? "en";
  const localeData = getBlogDataByLocale("check-jewellery-product-dimensions-weight", locale);
  const sections = localeData && localeData.length > 0 ? localeData : articleSections;
