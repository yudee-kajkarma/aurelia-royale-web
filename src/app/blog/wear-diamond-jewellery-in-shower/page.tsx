...
export const metadataEn: Metadata = {
  title: "Wear Diamond Jewellery In Shower",
  description: "Wear Diamond Jewellery In Shower",
  alternates: {
...
export const metadataEs: Metadata = {
  title: "Use joyas de diamantes en la ducha",
  description: "Use joyas de diamantes en la ducha - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/wear-diamond-jewellery-in-shower/",
  },
};

export const metadataFr: Metadata = {
  title: "Portez des bijoux en diamant sous la douche",
  description: "Portez des bijoux en diamant sous la douche - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/wear-diamond-jewellery-in-shower/",
  },
};
...
export const metadataNl: Metadata = {
  title: "Draag diamanten sieraden onder de douche",
  description: "Draag diamanten sieraden onder de douche - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/wear-diamond-jewellery-in-shower/",
  },
};
...
export const metadataDe: Metadata = {
  title: "Tragen Sie Diamantschmuck unter der Dusche",
  description: "Tragen Sie Diamantschmuck unter der Dusche - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/wear-diamond-jewellery-in-shower/",
  },
};
...
export const metadataIt: Metadata = {
  title: "I gioielli con diamanti possono essere indossati sotto la doccia? Suggerimenti",
  description: "Evitare l'accumulo di saponi e oli. Scopri come l'acqua del rubinetto e i prodotti da bagno appannano i diamanti e indeboliscono le castoni. - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/it/blog/wear-diamond-jewellery-in-shower/",
  },
};
...
export default async function Page({ searchParams }: { searchParams: Promise<{ locale?: string }> }) {
  ...
  const localeData = getBlogDataByLocale("wear-diamond-jewellery-in-shower", locale);
