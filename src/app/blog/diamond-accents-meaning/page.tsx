...
export const metadataEn: Metadata = {
  title: "Diamond Accents Meaning",
  description: "Diamond Accents Meaning",
  alternates: {
...
export const metadataEs: Metadata = {
  title: "Significado de los acentos de diamante",
  description: "Significado de los acentos de diamante - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/diamond-accents-meaning/",
  },
};

export const metadataFr: Metadata = {
  title: "Signification des accents de diamant",
  description: "Signification des accents de diamant - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/diamond-accents-meaning/",
  },
};
...
export const metadataNl: Metadata = {
  title: "Diamantaccenten Betekenis",
  description: "Diamantaccenten Betekenis - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/diamond-accents-meaning/",
  },
};
...
export const metadataDe: Metadata = {
  title: "Bedeutung von Diamantakzenten",
  description: "Bedeutung von Diamantakzenten - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/diamond-accents-meaning/",
  },
};
...
export const metadataIt: Metadata = {
  title: "Cosa sono i diamanti accentati? Definizione e importanza",
  description: "Comprendi cosa definisce un diamante d'accento, le forme comuni utilizzate e come contribuiscono alla brillantezza generale e al design dei gioielli. - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/it/blog/diamond-accents-meaning/",
  },
};
  ...
  "@graph": [
    ...
    },
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 4, "name": "What Does Diamond Accents Mean in Jewellery?", "item": "https://www.aureliaroyale.com/blog/diamond-accents-meaning/" }
      ]
    },
    {
      "@type": "FAQPage",
...
export default async function Page({ searchParams }: { searchParams: Promise<{ locale?: string }> }) {
  ...
  const localeData = getBlogDataByLocale("diamond-accents-meaning", locale);
