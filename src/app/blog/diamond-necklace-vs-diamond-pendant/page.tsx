...
export const metadataEn: Metadata = {
  ...
  description: "Diamond Necklace Vs Diamond Pendant",
  alternates: {
...
export const metadataEs: Metadata = {
  title: "Collar de diamantes versus colgante de diamantes",
  description: "Collar de diamantes versus colgante de diamantes - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/diamond-necklace-vs-diamond-pendant/",
  },
};

export const metadataFr: Metadata = {
  title: "Collier diamant vs pendentif diamant",
  description: "Collier diamant vs pendentif diamant - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/diamond-necklace-vs-diamond-pendant/",
  },
};
...
export const metadataNl: Metadata = {
  title: "Diamanten halsketting versus diamanten hanger",
  description: "Diamanten halsketting versus diamanten hanger - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/diamond-necklace-vs-diamond-pendant/",
  },
};
...
export const metadataDe: Metadata = {
  title: "Diamant-Halskette vs. Diamant-Anhänger",
  description: "Diamant-Halskette vs. Diamant-Anhänger - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/diamond-necklace-vs-diamond-pendant/",
  },
};
...
export const metadataIt: Metadata = {
  title: "Collana di diamanti vs Ciondolo di diamanti",
  description: "Scopri le differenze di design tra un ciondolo classico e una collana che incorpora diamanti lungo la catena e come scegliere quello giusto. - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/it/blog/diamond-necklace-vs-diamond-pendant/",
  },
};
...
export async function generateMetadata({ searchParams }: { searchParams: Promise<{ locale?: string }> }): Promise<Metadata> {
  ...
  const localeData = getBlogDataByLocale("diamond-necklace-vs-diamond-pendant", locale);
...
export default async function DiamondNecklaceVsDiamondPendantPage({ searchParams }: { searchParams: Promise<{ locale?: string }> }) {
  const resolvedSearchParams = await searchParams;
  const locale = resolvedSearchParams.locale ?? "en";
  const localeData = getBlogDataByLocale("diamond-necklace-vs-diamond-pendant", locale);
  const sections = localeData && localeData.length > 0 ? localeData : articleSections;
