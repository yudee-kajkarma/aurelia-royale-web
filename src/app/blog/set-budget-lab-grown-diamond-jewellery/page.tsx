...
export const metadataEn: Metadata = {
  title: "Set Budget Lab Grown Diamond Jewellery",
  description: "Set Budget Lab Grown Diamond Jewellery",
  alternates: {
...
export const metadataEs: Metadata = {
  title: "Conjunto de joyería económica con diamantes cultivados en laboratorio",
  description: "Conjunto de joyería económica con diamantes cultivados en laboratorio - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/set-budget-lab-grown-diamond-jewellery/",
  },
};

export const metadataFr: Metadata = {
  title: "Ensemble de bijoux en diamants cultivés en laboratoire à petit budget",
  description: "Ensemble de bijoux en diamants cultivés en laboratoire à petit budget - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/set-budget-lab-grown-diamond-jewellery/",
  },
};
...
export const metadataNl: Metadata = {
  title: "Set Budget Lab Grown-diamantenjuwelen",
  description: "Set Budget Lab Grown-diamantenjuwelen - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/set-budget-lab-grown-diamond-jewellery/",
  },
};
...
export const metadataDe: Metadata = {
  title: "Set Budget-Lab-Grown-Diamantschmuck",
  description: "Set Budget-Lab-Grown-Diamantschmuck - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/set-budget-lab-grown-diamond-jewellery/",
  },
};
...
export const metadataIt: Metadata = {
  title: "Come impostare un budget per i gioielli con diamanti coltivati in laboratorio",
  description: "Ottimizza il tuo investimento. Scopri come allocare il tuo budget tra la qualità del diamante coltivato in laboratorio, il metallo dell'incastonatura e il design del pezzo. - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/it/blog/set-budget-lab-grown-diamond-jewellery/",
  },
};
...
export default async function Page({ searchParams }: { searchParams: Promise<{ locale?: string }> }) {
  ...
  const localeData = getBlogDataByLocale("set-budget-lab-grown-diamond-jewellery", locale);
