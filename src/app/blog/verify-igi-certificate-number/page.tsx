...
export const metadataEn: Metadata = {
  title: "Verify Igi Certificate Number",
  description: "Verify Igi Certificate Number",
  alternates: {
...
export const metadataEs: Metadata = {
  title: "Verificar el número de certificado Igi",
  description: "Verificar el número de certificado Igi - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/verify-igi-certificate-number/",
  },
};

export const metadataFr: Metadata = {
  title: "Vérifier le numéro de certificat Igi",
  description: "Vérifier le numéro de certificat Igi - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/verify-igi-certificate-number/",
  },
};
...
export const metadataNl: Metadata = {
  title: "Controleer het Igi-certificaatnummer",
  description: "Controleer het Igi-certificaatnummer - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/verify-igi-certificate-number/",
  },
};
...
export const metadataDe: Metadata = {
  title: "Überprüfen Sie die Igi-Zertifikatsnummer",
  description: "Überprüfen Sie die Igi-Zertifikatsnummer - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/verify-igi-certificate-number/",
  },
};
...
export const metadataIt: Metadata = {
  title: "Come verificare il numero del certificato IGI online",
  description: "Conferma l'autenticità del tuo diamante coltivato in laboratorio. Guida passo passo per utilizzare lo strumento ufficiale di verifica del certificato IGI online. - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/it/blog/verify-igi-certificate-number/",
  },
};
...
export async function generateMetadata({ searchParams }: { searchParams: Promise<{ locale?: string }> }): Promise<Metadata> {
  ...
  const localeData = getBlogDataByLocale("verify-igi-certificate-number", locale);
...
export default async function Blog23Page({ searchParams }: { searchParams: Promise<{ locale?: string }> }) {
  const resolvedSearchParams = await searchParams;
  const locale = resolvedSearchParams.locale ?? "en";
  const localeData = getBlogDataByLocale("verify-igi-certificate-number", locale);
  const sections = localeData && localeData.length > 0 ? localeData : articleSections;
      ...
      <section className="relative left-1/2 w-screen -translate-x-1/2 bg-[#e8e5dc] py-16">
        <div className="mx-auto max-w-4xl px-6 text-center">
          ...
          <p className="mt-6 font-jost text-sm font-light uppercase tracking-widest text-[#5a5a5a]">
            {locale === "it" ? "Journal • Pubblicato il 16 luglio 2026" : locale === "fr" ? "Guide de Registre • Publié le 16. Juli 2026" : locale === "es" ? "Guía de Registro • Publicado el 16 de julio de 2026" : "Registry Guide • Published July 16, 2026"}
          </p>
        </div>
      </section>
