...
export const metadataEn: Metadata = {
  title: "How Should Diamond Ring Fit",
  description: "How Should Diamond Ring Fit",
  alternates: {
...
export const metadataEs: Metadata = {
  title: "¿Cómo debe encajar el anillo de diamantes?",
  description: "¿Cómo debe encajar el anillo de diamantes? - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/how-should-diamond-ring-fit/",
  },
};

export const metadataFr: Metadata = {
  title: "Comment la bague en diamant devrait-elle s'adapter",
  description: "Comment la bague en diamant devrait-elle s'adapter - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/how-should-diamond-ring-fit/",
  },
};
...
export const metadataNl: Metadata = {
  title: "Hoe moet een diamanten ring passen",
  description: "Hoe moet een diamanten ring passen - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/how-should-diamond-ring-fit/",
  },
};
...
export const metadataDe: Metadata = {
  title: "Wie sollte ein Diamantring passen?",
  description: "Wie sollte ein Diamantring passen? - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/how-should-diamond-ring-fit/",
  },
};
...
export const metadataIt: Metadata = {
  title: "Come dovrebbe apparire un anello con diamante? Guida alla regolazione",
  description: "Garantire il comfort quotidiano ed evitare perdite. Impara come valutare la vestibilità dell'anello sulle nocche e come i cambiamenti di temperatura lo influenzano. - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/it/blog/how-should-diamond-ring-fit/",
  },
};
...
export async function generateMetadata({ searchParams }: { searchParams: Promise<{ locale?: string }> }): Promise<Metadata> {
  ...
  const localeData = getBlogDataByLocale("how-should-diamond-ring-fit", locale);
...
export default async function HowShouldDiamondRingFitPage({ searchParams }: { searchParams: Promise<{ locale?: string }> }) {
  const resolvedSearchParams = await searchParams;
  const locale = resolvedSearchParams.locale ?? "en";
  const localeData = getBlogDataByLocale("how-should-diamond-ring-fit", locale);
  const sections = localeData && localeData.length > 0 ? localeData : articleSections;
