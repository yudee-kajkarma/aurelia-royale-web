...
export const metadataEn: Metadata = {
  title: "Choose Diamond Jewellery Without Seeing In Person",
  description: "Choose Diamond Jewellery Without Seeing In Person",
  alternates: {
...
export const metadataEs: Metadata = {
  title: "Elija joyas de diamantes sin verlo en persona",
  description: "Elija joyas de diamantes sin verlo en persona - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/choose-diamond-jewellery-without-seeing-in-person/",
  },
};

export const metadataFr: Metadata = {
  title: "Choisissez des bijoux en diamant sans les voir en personne",
  description: "Choisissez des bijoux en diamant sans les voir en personne - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/choose-diamond-jewellery-without-seeing-in-person/",
  },
};
...
export const metadataNl: Metadata = {
  title: "Kies diamanten sieraden zonder ze persoonlijk te zien",
  description: "Kies diamanten sieraden zonder ze persoonlijk te zien - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/choose-diamond-jewellery-without-seeing-in-person/",
  },
};
...
export const metadataDe: Metadata = {
  title: "Wählen Sie Diamantschmuck, ohne ihn persönlich zu sehen",
  description: "Wählen Sie Diamantschmuck, ohne ihn persönlich zu sehen - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/choose-diamond-jewellery-without-seeing-in-person/",
  },
};
...
export const metadataIt: Metadata = {
  title: "Come scegliere gioielli con diamanti online senza vederli di persona",
  description: "Prendi decisioni di acquisto sicure. Utilizza guide alle taglie, immagini ad alta risoluzione, video di gestione e consulenze virtuali per valutare i pezzi. - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/it/blog/choose-diamond-jewellery-without-seeing-in-person/",
  },
};
...
export async function generateMetadata({ searchParams }: { searchParams: Promise<{ locale?: string }> }): Promise<Metadata> {
  ...
  const localeData = getBlogDataByLocale("choose-diamond-jewellery-without-seeing-in-person", locale);
...
export default async function ChooseDiamondJewelleryWithoutSeeingPage({ searchParams }: { searchParams: Promise<{ locale?: string }> }) {
  const resolvedSearchParams = await searchParams;
  const locale = resolvedSearchParams.locale ?? "en";
  const localeData = getBlogDataByLocale("choose-diamond-jewellery-without-seeing-in-person", locale);
  const sections = localeData && localeData.length > 0 ? localeData : articleSections;
