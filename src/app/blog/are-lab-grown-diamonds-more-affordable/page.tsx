...
export const metadataEn: Metadata = {
  title: "Are Lab Grown Diamonds More Affordable",
  description: "Are Lab Grown Diamonds More Affordable",
  alternates: {
...
export const metadataEs: Metadata = {
  title: "¿Son más asequibles los diamantes cultivados en laboratorio?",
  description: "¿Son más asequibles los diamantes cultivados en laboratorio? - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/are-lab-grown-diamonds-more-affordable/",
  },
};

export const metadataFr: Metadata = {
  title: "Les diamants cultivés en laboratoire sont-ils plus abordables",
  description: "Les diamants cultivés en laboratoire sont-ils plus abordables - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/are-lab-grown-diamonds-more-affordable/",
  },
};
...
export const metadataNl: Metadata = {
  title: "Zijn in het laboratorium gekweekte diamanten betaalbaarder?",
  description: "Zijn in het laboratorium gekweekte diamanten betaalbaarder? - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/are-lab-grown-diamonds-more-affordable/",
  },
};
...
export const metadataDe: Metadata = {
  title: "Sind im Labor gezüchtete Diamanten erschwinglicher?",
  description: "Sind im Labor gezüchtete Diamanten erschwinglicher? - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/are-lab-grown-diamonds-more-affordable/",
  },
};
...
export const metadataIt: Metadata = {
  title: "I diamanti creati in laboratorio sono più economici dei diamanti naturali?",
  description: "Scopri perché i diamanti coltivati ​​in laboratorio spesso costano meno dei diamanti naturali e come confrontare correttamente taglio, dimensione, rapporto, metallo, IVA e prezzi totali dei gioielli. - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/it/blog/are-lab-grown-diamonds-more-affordable/",
  },
};
...
export async function generateMetadata({ searchParams }: { searchParams: Promise<{ locale?: string }> }): Promise<Metadata> {
  ...
  const localeData = getBlogDataByLocale("are-lab-grown-diamonds-more-affordable", locale);
...
export default async function Blog18Page({ searchParams }: { searchParams: Promise<{ locale?: string }> }) {
  const resolvedSearchParams = await searchParams;
  const locale = resolvedSearchParams.locale ?? "en";
  const localeData = getBlogDataByLocale("are-lab-grown-diamonds-more-affordable", locale);
  const sections = localeData && localeData.length > 0 ? localeData : articleSections;
