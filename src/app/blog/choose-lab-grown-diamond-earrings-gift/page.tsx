...
export const metadataEn: Metadata = {
  title: "Choose Lab Grown Diamond Earrings Gift",
  description: "Choose Lab Grown Diamond Earrings Gift",
  alternates: {
...
export const metadataEs: Metadata = {
  title: "Elija el regalo de aretes de diamantes cultivados en laboratorio",
  description: "Elija el regalo de aretes de diamantes cultivados en laboratorio - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/choose-lab-grown-diamond-earrings-gift/",
  },
};

export const metadataFr: Metadata = {
  title: "Choisissez un cadeau de boucles d'oreilles en diamant cultivé en laboratoire",
  description: "Choisissez un cadeau de boucles d'oreilles en diamant cultivé en laboratoire - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/choose-lab-grown-diamond-earrings-gift/",
  },
};
...
export const metadataNl: Metadata = {
  title: "Kies Lab Grown Diamond Oorbellen cadeau",
  description: "Kies Lab Grown Diamond Oorbellen cadeau - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/choose-lab-grown-diamond-earrings-gift/",
  },
};
...
export const metadataDe: Metadata = {
  title: "Wählen Sie ein Geschenk für Ohrringe mit im Labor gezüchteten Diamanten",
  description: "Wählen Sie ein Geschenk für Ohrringe mit im Labor gezüchteten Diamanten - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/choose-lab-grown-diamond-earrings-gift/",
  },
};
...
export const metadataIt: Metadata = {
  title: "Come scegliere come regalo orecchini con diamanti creati in laboratorio",
  description: "Trova il paio di orecchini perfetto da regalare. Confronta gli stili con bottoni, a goccia e a cerchio e scegli l'impostazione e le chiusure giuste per il tuo comfort. - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/it/blog/choose-lab-grown-diamond-earrings-gift/",
  },
};
...
export async function generateMetadata({ searchParams }: { searchParams: Promise<{ locale?: string }> }): Promise<Metadata> {
  ...
  const localeData = getBlogDataByLocale("choose-lab-grown-diamond-earrings-gift", locale);
    ...
    content: [
      ...
      },
      {
        ...
        rows: [
          ...
          ["Multiple piercings", "Neind for a small footprint or coordinated stack", "Available space without measurements"],
...
export default async function ChooseLabGrownDiamondEarringsGiftPage({ searchParams }: { searchParams: Promise<{ locale?: string }> }) {
  const resolvedSearchParams = await searchParams;
  const locale = resolvedSearchParams.locale ?? "en";
  const localeData = getBlogDataByLocale("choose-lab-grown-diamond-earrings-gift", locale);
  const sections = localeData && localeData.length > 0 ? localeData : articleSections;
