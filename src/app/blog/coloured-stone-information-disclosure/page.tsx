...
export const metadataEn: Metadata = {
  title: "Coloured Stone Information Disclosure",
  description: "Coloured Stone Information Disclosure",
  alternates: {
...
export const metadataEs: Metadata = {
  title: "Divulgación de información sobre piedras coloreadas",
  description: "Divulgación de información sobre piedras coloreadas - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/coloured-stone-information-disclosure/",
  },
};

export const metadataFr: Metadata = {
  title: "Divulgation d'informations sur les pierres colorées",
  description: "Divulgation d'informations sur les pierres colorées - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/coloured-stone-information-disclosure/",
  },
};
...
export const metadataNl: Metadata = {
  title: "Gekleurde steen informatie openbaarmaking",
  description: "Gekleurde steen informatie openbaarmaking - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/coloured-stone-information-disclosure/",
  },
};
...
export const metadataDe: Metadata = {
  title: "Offenlegung von Informationen zu farbigen Steinen",
  description: "Offenlegung von Informationen zu farbigen Steinen - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/coloured-stone-information-disclosure/",
  },
};
...
export const metadataIt: Metadata = {
  title: "Divulgazione di informazioni sulle pietre colorate: cosa cercare",
  description: "Assicurati di sapere esattamente cosa stai acquistando. Impara le informazioni essenziali che i gioiellieri devono fornire sull'origine e sul trattamento delle gemme. - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/it/blog/coloured-stone-information-disclosure/",
  },
};
...
export default async function Page({ searchParams }: { searchParams: Promise<{ locale?: string }> }) {
  ...
  const localeData = getBlogDataByLocale("coloured-stone-information-disclosure", locale);
