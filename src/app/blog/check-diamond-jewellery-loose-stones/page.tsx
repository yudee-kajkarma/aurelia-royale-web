...
export const metadataEn: Metadata = {
  title: "Check Diamond Jewellery Loose Stones",
  description: "Check Diamond Jewellery Loose Stones",
  alternates: {
...
export const metadataEs: Metadata = {
  title: "Joyas con diamantes a cuadros y piedras sueltas",
  description: "Joyas con diamantes a cuadros y piedras sueltas - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/check-diamond-jewellery-loose-stones/",
  },
};

export const metadataFr: Metadata = {
  title: "Vérifier les bijoux en diamant, les pierres en vrac",
  description: "Vérifier les bijoux en diamant, les pierres en vrac - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/check-diamond-jewellery-loose-stones/",
  },
};
...
export const metadataNl: Metadata = {
  title: "Controleer diamanten sieraden losse stenen",
  description: "Controleer diamanten sieraden losse stenen - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/check-diamond-jewellery-loose-stones/",
  },
};
...
export const metadataDe: Metadata = {
  title: "Überprüfen Sie die losen Diamantschmucksteine",
  description: "Überprüfen Sie die losen Diamantschmucksteine - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/check-diamond-jewellery-loose-stones/",
  },
};
...
export const metadataIt: Metadata = {
  title: "Come verificare la presenza di pietre sciolte nei tuoi gioielli con diamanti",
  description: "Impara semplici metodi a casa per verificare se le pietre sono salde nei tuoi artigli e cosa fare se noti movimenti o allentamenti. - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/it/blog/check-diamond-jewellery-loose-stones/",
  },
};
...
export default async function Page({ searchParams }: { searchParams: Promise<{ locale?: string }> }) {
  ...
  const localeData = getBlogDataByLocale("check-diamond-jewellery-loose-stones", locale);
