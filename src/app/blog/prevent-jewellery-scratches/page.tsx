...
export const metadataEn: Metadata = {
  title: "Prevent Jewellery Scratches",
  description: "Prevent Jewellery Scratches",
  alternates: {
...
export const metadataEs: Metadata = {
  title: "Prevenir rayones en las joyas",
  description: "Prevenir rayones en las joyas - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/prevent-jewellery-scratches/",
  },
};

export const metadataFr: Metadata = {
  title: "Prévenir les rayures sur les bijoux",
  description: "Prévenir les rayures sur les bijoux - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/prevent-jewellery-scratches/",
  },
};
...
export const metadataNl: Metadata = {
  title: "Voorkom krassen op sieraden",
  description: "Voorkom krassen op sieraden - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/prevent-jewellery-scratches/",
  },
};
...
export const metadataDe: Metadata = {
  title: "Verhindern Sie Schmuckkratzer",
  description: "Verhindern Sie Schmuckkratzer - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/prevent-jewellery-scratches/",
  },
};
...
export const metadataIt: Metadata = {
  title: "Come evitare graffi e danni ai tuoi gioielli con diamanti",
  description: "Sebbene il diamante sia molto duro, il metallo della montatura può graffiarsi. Scopri come conservare i pezzi separatamente nel tuo portagioie. - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/it/blog/prevent-jewellery-scratches/",
  },
};
...
export default async function Page({ searchParams }: { searchParams: Promise<{ locale?: string }> }) {
  ...
  const localeData = getBlogDataByLocale("prevent-jewellery-scratches", locale);
