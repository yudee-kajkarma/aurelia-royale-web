...
export const metadataEn: Metadata = {
  ...
  description: "Lab Grown Diamond Carat Weight Explained",
  alternates: {
...
export const metadataEs: Metadata = {
  title: "Peso en quilates del diamante cultivado en laboratorio explicado",
  description: "Peso en quilates del diamante cultivado en laboratorio explicado - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/lab-grown-diamond-carat-weight-explained/",
  },
};

export const metadataFr: Metadata = {
  title: "Explication du poids en carats du diamant cultivé en laboratoire",
  description: "Explication du poids en carats du diamant cultivé en laboratoire - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/lab-grown-diamond-carat-weight-explained/",
  },
};
...
export const metadataNl: Metadata = {
  title: "In het laboratorium gekweekte diamant karaatgewicht uitgelegd",
  description: "In het laboratorium gekweekte diamant karaatgewicht uitgelegd - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/lab-grown-diamond-carat-weight-explained/",
  },
};
...
export const metadataDe: Metadata = {
  title: "Das Karatgewicht von im Labor gezüchteten Diamanten wird erklärt",
  description: "Das Karatgewicht von im Labor gezüchteten Diamanten wird erklärt - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/lab-grown-diamond-carat-weight-explained/",
  },
};
...
export const metadataIt: Metadata = {
  title: "Spiegazione del peso in carati del diamante creato in laboratorio",
  description: "Scopri come viene misurata la caratura nei diamanti creati in laboratorio e come il peso influenza il prezzo in modo esponenziale. - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/it/blog/lab-grown-diamond-carat-weight-explained/",
  },
};
...
export async function generateMetadata({ searchParams }: { searchParams: Promise<{ locale?: string }> }): Promise<Metadata> {
  ...
  const localeData = getBlogDataByLocale("lab-grown-diamond-carat-weight-explained", locale);
...
export default async function Blog30Page({ searchParams }: { searchParams: Promise<{ locale?: string }> }) {
  const resolvedSearchParams = await searchParams;
  const locale = resolvedSearchParams.locale ?? "en";
  const localeData = getBlogDataByLocale("lab-grown-diamond-carat-weight-explained", locale);
  const sections = localeData && localeData.length > 0 ? localeData : articleSections;
