...
export const metadataEn: Metadata = {
  title: "Diamond Laser Inscription",
  description: "Diamond Laser Inscription",
  alternates: {
...
export const metadataEs: Metadata = {
  title: "Inscripción láser de diamante",
  description: "Inscripción láser de diamante - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/diamond-laser-inscription/",
  },
};

export const metadataFr: Metadata = {
  title: "Inscription au laser diamant",
  description: "Inscription au laser diamant - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/diamond-laser-inscription/",
  },
};
...
export const metadataNl: Metadata = {
  title: "Diamantlaserinscriptie",
  description: "Diamantlaserinscriptie - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/diamond-laser-inscription/",
  },
};
...
export const metadataDe: Metadata = {
  title: "Diamant-Laserbeschriftung",
  description: "Diamant-Laserbeschriftung - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/diamond-laser-inscription/",
  },
};
...
export const metadataIt: Metadata = {
  title: "Iscrizioni laser sui diamanti: cosa sono e perché sono importanti",
  description: "Scopri come le iscrizioni microscopiche sulla cintura di diamanti confermano l'autenticità, il numero del certificato e l'origine del laboratorio. - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/it/blog/diamond-laser-inscription/",
  },
};
...
export default async function Page({ searchParams }: { searchParams: Promise<{ locale?: string }> }) {
  ...
  const localeData = getBlogDataByLocale("diamond-laser-inscription", locale);
