...
export const metadataEn: Metadata = {
  title: "What Determines Price Lab Grown Diamond Jewellery",
  description: "What Determines Price Lab Grown Diamond Jewellery",
  alternates: {
...
export const metadataEs: Metadata = {
  title: "¿Qué determina el precio de las joyas con diamantes cultivados en laboratorio?",
  description: "¿Qué determina el precio de las joyas con diamantes cultivados en laboratorio? - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/what-determines-price-lab-grown-diamond-jewellery/",
  },
};

export const metadataFr: Metadata = {
  title: "Ce qui détermine le prix des bijoux en diamants cultivés en laboratoire",
  description: "Ce qui détermine le prix des bijoux en diamants cultivés en laboratoire - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/what-determines-price-lab-grown-diamond-jewellery/",
  },
};
...
export const metadataNl: Metadata = {
  title: "Wat bepaalt de prijs van lab-gekweekte diamanten sieraden",
  description: "Wat bepaalt de prijs van lab-gekweekte diamanten sieraden - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/what-determines-price-lab-grown-diamond-jewellery/",
  },
};
...
export const metadataDe: Metadata = {
  title: "Was bestimmt den Preis von im Labor gezüchtetem Diamantschmuck?",
  description: "Was bestimmt den Preis von im Labor gezüchtetem Diamantschmuck? - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/what-determines-price-lab-grown-diamond-jewellery/",
  },
};
...
export const metadataIt: Metadata = {
  title: "Cosa determina il prezzo dei gioielli con diamanti coltivati in laboratorio?",
  description: "Comprendere i fattori che influenzano il costo finale. Valuta equamente il design dell'impostazione, il peso in carati e i margini del rivenditore. - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/it/blog/what-determines-price-lab-grown-diamond-jewellery/",
  },
};
...
export default async function Page({ searchParams }: { searchParams: Promise<{ locale?: string }> }) {
  ...
  const localeData = getBlogDataByLocale("what-determines-price-lab-grown-diamond-jewellery", locale);
