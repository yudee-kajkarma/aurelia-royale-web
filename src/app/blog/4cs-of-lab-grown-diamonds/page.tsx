...
export const metadataEn: Metadata = {
  title: "4cs Of Lab Grown Diamonds",
  description: "4cs Of Lab Grown Diamonds",
  alternates: {
...
export const metadataEs: Metadata = {
  title: "4cs de diamantes cultivados en laboratorio",
  description: "4cs de diamantes cultivados en laboratorio - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/4cs-of-lab-grown-diamonds/",
  },
};

export const metadataFr: Metadata = {
  title: "4cs de diamants cultivés en laboratoire",
  description: "4cs de diamants cultivés en laboratoire - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/4cs-of-lab-grown-diamonds/",
  },
};
...
export const metadataNl: Metadata = {
  title: "4cs laboratoriumgekweekte diamanten",
  description: "4cs laboratoriumgekweekte diamanten - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/4cs-of-lab-grown-diamonds/",
  },
};
...
export const metadataDe: Metadata = {
  title: "4 Stück im Labor gezüchtete Diamanten",
  description: "4 Stück im Labor gezüchtete Diamanten - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/4cs-of-lab-grown-diamonds/",
  },
};
...
export const metadataIt: Metadata = {
  title: "Le 4 C dei diamanti creati in laboratorio: una guida all'acquisto",
  description: "Comprendi le 4 C dei diamanti coltivati ​​in laboratorio (taglio, colore, purezza e carati) e impara come bilanciare i gradi nella scelta dei gioielli. - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/it/blog/4cs-of-lab-grown-diamonds/",
  },
};
...
export async function generateMetadata({ searchParams }: { searchParams: Promise<{ locale?: string }> }): Promise<Metadata> {
  ...
  const localeData = getBlogDataByLocale("4cs-of-lab-grown-diamonds", locale);
...
export default async function Blog26Page({ searchParams }: { searchParams: Promise<{ locale?: string }> }) {
  const resolvedSearchParams = await searchParams;
  const locale = resolvedSearchParams.locale ?? "en";
  const localeData = getBlogDataByLocale("4cs-of-lab-grown-diamonds", locale);
  const sections = localeData && localeData.length > 0 ? localeData : articleSections;
