...
export const metadataEn: Metadata = {
  ...
  description: "How To Measure Ring Size",
  alternates: {
...
export const metadataEs: Metadata = {
  title: "Cómo medir el tamaño del anillo",
  description: "Cómo medir el tamaño del anillo - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/how-to-measure-ring-size/",
  },
};

export const metadataFr: Metadata = {
  title: "Comment mesurer la taille de la bague",
  description: "Comment mesurer la taille de la bague - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/how-to-measure-ring-size/",
  },
};
...
export const metadataNl: Metadata = {
  title: "Hoe ringmaat te meten",
  description: "Hoe ringmaat te meten - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/how-to-measure-ring-size/",
  },
};
...
export const metadataDe: Metadata = {
  title: "So messen Sie die Ringgröße",
  description: "So messen Sie die Ringgröße - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/how-to-measure-ring-size/",
  },
};
...
export const metadataIt: Metadata = {
  title: "Come misurare la misura dell'anello a casa: guida completa",
  description: "Evita costosi ridimensionamenti. Impara metodi affidabili per misurare la circonferenza del dito a casa utilizzando strumenti semplici. - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/it/blog/how-to-measure-ring-size/",
  },
};
...
export async function generateMetadata({ searchParams }: { searchParams: Promise<{ locale?: string }> }): Promise<Metadata> {
  ...
  const localeData = getBlogDataByLocale("how-to-measure-ring-size", locale);
...
export default async function HowToMeasureRingSizePage({ searchParams }: { searchParams: Promise<{ locale?: string }> }) {
  const resolvedSearchParams = await searchParams;
  const locale = resolvedSearchParams.locale ?? "en";
  const localeData = getBlogDataByLocale("how-to-measure-ring-size", locale);
  const sections = localeData && localeData.length > 0 ? localeData : articleSections;
