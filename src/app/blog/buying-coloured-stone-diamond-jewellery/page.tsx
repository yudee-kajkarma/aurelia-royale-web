...
export const metadataEn: Metadata = {
  title: "Buying Coloured Stone Diamond Jewellery",
  description: "Buying Coloured Stone Diamond Jewellery",
  alternates: {
...
export const metadataEs: Metadata = {
  title: "Comprar joyas de diamantes de piedras de colores",
  description: "Comprar joyas de diamantes de piedras de colores - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/buying-coloured-stone-diamond-jewellery/",
  },
};

export const metadataFr: Metadata = {
  title: "Acheter des bijoux en diamant et pierre colorée",
  description: "Acheter des bijoux en diamant et pierre colorée - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/buying-coloured-stone-diamond-jewellery/",
  },
};
...
export const metadataNl: Metadata = {
  title: "Gekleurde stenen diamanten sieraden kopen",
  description: "Gekleurde stenen diamanten sieraden kopen - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/buying-coloured-stone-diamond-jewellery/",
  },
};
...
export const metadataDe: Metadata = {
  title: "Kauf von Diamantschmuck aus farbigen Steinen",
  description: "Kauf von Diamantschmuck aus farbigen Steinen - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/buying-coloured-stone-diamond-jewellery/",
  },
};
...
export const metadataIt: Metadata = {
  title: "Acquistare gioielli con diamanti e pietre di colore: Lista di controllo",
  description: "Verifica l'identità della gemma, lo stato naturale o coltivato in laboratorio, i trattamenti, il colore, le dimensioni, i dettagli in diamante, il metallo, i report e la cura prima dell'acquisto. - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/it/blog/buying-coloured-stone-diamond-jewellery/",
  },
};
...
export default async function Page({ searchParams }: { searchParams: Promise<{ locale?: string }> }) {
  ...
  const localeData = getBlogDataByLocale("buying-coloured-stone-diamond-jewellery", locale);
