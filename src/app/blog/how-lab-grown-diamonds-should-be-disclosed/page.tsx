...
export const metadataEn: Metadata = {
  title: "How Lab Grown Diamonds Should Be Disclosed",
  description: "How Lab Grown Diamonds Should Be Disclosed",
  alternates: {
...
export const metadataEs: Metadata = {
  title: "Cómo se deben divulgar los diamantes cultivados en laboratorio",
  description: "Cómo se deben divulgar los diamantes cultivados en laboratorio - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/how-lab-grown-diamonds-should-be-disclosed/",
  },
};

export const metadataFr: Metadata = {
  title: "Comment les diamants cultivés en laboratoire doivent être divulgués",
  description: "Comment les diamants cultivés en laboratoire doivent être divulgués - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/how-lab-grown-diamonds-should-be-disclosed/",
  },
};
...
export const metadataNl: Metadata = {
  title: "Hoe in het laboratorium gekweekte diamanten openbaar moeten worden gemaakt",
  description: "Hoe in het laboratorium gekweekte diamanten openbaar moeten worden gemaakt - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/how-lab-grown-diamonds-should-be-disclosed/",
  },
};
...
export const metadataDe: Metadata = {
  title: "Wie im Labor gezüchtete Diamanten offengelegt werden sollten",
  description: "Wie im Labor gezüchtete Diamanten offengelegt werden sollten - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/how-lab-grown-diamonds-should-be-disclosed/",
  },
};
...
export const metadataIt: Metadata = {
  title: "Come dovrebbero essere divulgati i diamanti coltivati ​​in laboratorio",
  description: "Conoscere le normative aziendali. Scopri come i venditori dovrebbero etichettare chiaramente l'origine del laboratorio su descrizioni e fatture. - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/it/blog/how-lab-grown-diamonds-should-be-disclosed/",
  },
};
...
export async function generateMetadata({ searchParams }: { searchParams: Promise<{ locale?: string }> }): Promise<Metadata> {
  ...
  const localeData = getBlogDataByLocale("how-lab-grown-diamonds-should-be-disclosed", locale);
...
export default async function Blog20Page({ searchParams }: { searchParams: Promise<{ locale?: string }> }) {
  const resolvedSearchParams = await searchParams;
  const locale = resolvedSearchParams.locale ?? "en";
  const localeData = getBlogDataByLocale("how-lab-grown-diamonds-should-be-disclosed", locale);
  const sections = localeData && localeData.length > 0 ? localeData : articleSections;
