...
export const metadataEn: Metadata = {
  title: "High Quality Jewellery Product Images",
  description: "High Quality Jewellery Product Images",
  alternates: {
...
export const metadataEs: Metadata = {
  title: "Imágenes de productos de joyería de alta calidad",
  description: "Imágenes de productos de joyería de alta calidad - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/high-quality-jewellery-product-images/",
  },
};

export const metadataFr: Metadata = {
  title: "Images de produits de bijoux de haute qualité",
  description: "Images de produits de bijoux de haute qualité - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/high-quality-jewellery-product-images/",
  },
};
...
export const metadataNl: Metadata = {
  title: "Hoge kwaliteit sieraden productafbeeldingen",
  description: "Hoge kwaliteit sieraden productafbeeldingen - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/high-quality-jewellery-product-images/",
  },
};
...
export const metadataDe: Metadata = {
  title: "Hochwertige Schmuckproduktbilder",
  description: "Hochwertige Schmuckproduktbilder - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/high-quality-jewellery-product-images/",
  },
};
...
export const metadataIt: Metadata = {
  title: "Immagini di prodotti di gioielleria di alta qualità: cosa cercare",
  description: "Scopri come identificare immagini autentiche e dettagliate su un sito web di gioielli. Individua i ritocchi eccessivi e cerca viste macro realistiche. - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/it/blog/high-quality-jewellery-product-images/",
  },
};
...
export async function generateMetadata({ searchParams }: { searchParams: Promise<{ locale?: string }> }): Promise<Metadata> {
  ...
  const localeData = getBlogDataByLocale("high-quality-jewellery-product-images", locale);
...
export default async function HighQualityJewelleryProductImagesPage({ searchParams }: { searchParams: Promise<{ locale?: string }> }) {
  const resolvedSearchParams = await searchParams;
  const locale = resolvedSearchParams.locale ?? "en";
  const localeData = getBlogDataByLocale("high-quality-jewellery-product-images", locale);
  const sections = localeData && localeData.length > 0 ? localeData : articleSections;
