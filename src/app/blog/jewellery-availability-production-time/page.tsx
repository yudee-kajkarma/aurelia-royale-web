...
export const metadataEn: Metadata = {
  title: "Jewellery Availability Production Time",
  description: "Jewellery Availability Production Time",
  alternates: {
...
export const metadataEs: Metadata = {
  title: "Disponibilidad de joyería Tiempo de producción",
  description: "Disponibilidad de joyería Tiempo de producción - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/jewellery-availability-production-time/",
  },
};

export const metadataFr: Metadata = {
  title: "Disponibilité des bijoux Délai de production",
  description: "Disponibilité des bijoux Délai de production - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/jewellery-availability-production-time/",
  },
};
...
export const metadataNl: Metadata = {
  title: "Beschikbaarheid van sieraden Productietijd",
  description: "Beschikbaarheid van sieraden Productietijd - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/jewellery-availability-production-time/",
  },
};
...
export const metadataDe: Metadata = {
  title: "Produktionszeit der Schmuckverfügbarkeit",
  description: "Produktionszeit der Schmuckverfügbarkeit - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/jewellery-availability-production-time/",
  },
};
...
export const metadataIt: Metadata = {
  title: "Disponibilità e tempi di produzione dei gioielli: cosa aspettarsi",
  description: "Comprendere i tempi di consegna. Scopri la differenza oraria tra la spedizione di articoli pronti e di articoli fatti a mano su ordinazione. - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/it/blog/jewellery-availability-production-time/",
  },
};
...
export async function generateMetadata({ searchParams }: { searchParams: Promise<{ locale?: string }> }): Promise<Metadata> {
  ...
  const localeData = getBlogDataByLocale("jewellery-availability-production-time", locale);
...
export default async function JewelleryAvailabilityProductionTimePage({ searchParams }: { searchParams: Promise<{ locale?: string }> }) {
  const resolvedSearchParams = await searchParams;
  const locale = resolvedSearchParams.locale ?? "en";
  const localeData = getBlogDataByLocale("jewellery-availability-production-time", locale);
  const sections = localeData && localeData.length > 0 ? localeData : articleSections;
