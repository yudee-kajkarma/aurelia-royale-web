...
export const metadataEn: Metadata = {
  title: "Transparency Buying Diamond Jewellery",
  description: "Transparency Buying Diamond Jewellery",
  alternates: {
...
export const metadataEs: Metadata = {
  title: "Transparencia en la compra de joyas de diamantes",
  description: "Transparencia en la compra de joyas de diamantes - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/transparency-buying-diamond-jewellery/",
  },
};

export const metadataFr: Metadata = {
  title: "Transparence lors de l'achat de bijoux en diamant",
  description: "Transparence lors de l'achat de bijoux en diamant - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/transparency-buying-diamond-jewellery/",
  },
};
...
export const metadataNl: Metadata = {
  title: "Transparantie Diamantjuwelen kopen",
  description: "Transparantie Diamantjuwelen kopen - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/transparency-buying-diamond-jewellery/",
  },
};
...
export const metadataDe: Metadata = {
  title: "Transparenz beim Kauf von Diamantschmuck",
  description: "Transparenz beim Kauf von Diamantschmuck - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/transparency-buying-diamond-jewellery/",
  },
};
...
export const metadataIt: Metadata = {
  title: "Trasparenza nell'acquisto di gioielli con diamanti: cosa cercare",
  description: "Garantire un acquisto etico e consapevole. Cerca informazioni complete sull'origine del diamante, sui trattamenti dei metalli e sulla validità del rapporto. - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/it/blog/transparency-buying-diamond-jewellery/",
  },
};
...
export default async function Page({ searchParams }: { searchParams: Promise<{ locale?: string }> }) {
  ...
  const localeData = getBlogDataByLocale("transparency-buying-diamond-jewellery", locale);
