...
export const metadataEn: Metadata = {
  ...
  description: "Lab Grown Diamond Vs Cubic Zirconia",
  alternates: {
...
export const metadataEs: Metadata = {
  title: "Diamante cultivado en laboratorio versus circonita cúbica",
  description: "Diamante cultivado en laboratorio versus circonita cúbica - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/lab-grown-diamond-vs-cubic-zirconia/",
  },
};

export const metadataFr: Metadata = {
  title: "Diamant cultivé en laboratoire contre zircone cubique",
  description: "Diamant cultivé en laboratoire contre zircone cubique - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/lab-grown-diamond-vs-cubic-zirconia/",
  },
};
...
export const metadataNl: Metadata = {
  title: "Lab Grown Diamond versus zirkonia",
  description: "Lab Grown Diamond versus zirkonia - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/lab-grown-diamond-vs-cubic-zirconia/",
  },
};
...
export const metadataDe: Metadata = {
  title: "Im Labor gezüchteter Diamant vs. Zirkonia",
  description: "Im Labor gezüchteter Diamant vs. Zirkonia - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/lab-grown-diamond-vs-cubic-zirconia/",
  },
};
...
export const metadataIt: Metadata = {
  title: "Laboratorio creato diamante vs zirconia cubica",
  description: "Scopri le differenze nella composizione chimica, nella durezza e nella brillantezza tra un vero diamante coltivato in laboratorio e una zirconia simulata. - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/it/blog/lab-grown-diamond-vs-cubic-zirconia/",
  },
};
...
export async function generateMetadata({ searchParams }: { searchParams: Promise<{ locale?: string }> }): Promise<Metadata> {
  ...
  const localeData = getBlogDataByLocale("lab-grown-diamond-vs-cubic-zirconia", locale);
