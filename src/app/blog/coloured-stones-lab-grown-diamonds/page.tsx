...
export const metadataEn: Metadata = {
  title: "Coloured Stones Lab Grown Diamonds",
  description: "Coloured Stones Lab Grown Diamonds",
  alternates: {
...
export const metadataEs: Metadata = {
  title: "Diamantes cultivados en laboratorio de piedras de colores",
  description: "Diamantes cultivados en laboratorio de piedras de colores - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/coloured-stones-lab-grown-diamonds/",
  },
};

export const metadataFr: Metadata = {
  title: "Pierres colorées, diamants cultivés en laboratoire",
  description: "Pierres colorées, diamants cultivés en laboratoire - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/coloured-stones-lab-grown-diamonds/",
  },
};
...
export const metadataNl: Metadata = {
  title: "Gekleurde stenen in het laboratorium gekweekte diamanten",
  description: "Gekleurde stenen in het laboratorium gekweekte diamanten - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/coloured-stones-lab-grown-diamonds/",
  },
};
...
export const metadataDe: Metadata = {
  title: "Farbige Steine, im Labor gezüchtete Diamanten",
  description: "Farbige Steine, im Labor gezüchtete Diamanten - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/coloured-stones-lab-grown-diamonds/",
  },
};
...
export const metadataIt: Metadata = {
  title: "Pietre colorate con diamanti creati in laboratorio: una guida alla progettazione",
  description: "Esplora straordinarie combinazioni di design. Impara come accentuare le pietre preziose colorate come zaffiri o smeraldi con diamanti coltivati ​​in laboratorio. - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/it/blog/coloured-stones-lab-grown-diamonds/",
  },
};
...
export default async function Page({ searchParams }: { searchParams: Promise<{ locale?: string }> }) {
  ...
  const localeData = getBlogDataByLocale("coloured-stones-lab-grown-diamonds", locale);
