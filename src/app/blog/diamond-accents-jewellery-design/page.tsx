...
export const metadataEn: Metadata = {
  title: "Diamond Accents Jewellery Design",
  description: "Diamond Accents Jewellery Design",
  alternates: {
...
export const metadataEs: Metadata = {
  title: "Diseño de joyas con detalles de diamantes",
  description: "Diseño de joyas con detalles de diamantes - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/diamond-accents-jewellery-design/",
  },
};

export const metadataFr: Metadata = {
  title: "Conception de bijoux avec accents de diamants",
  description: "Conception de bijoux avec accents de diamants - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/diamond-accents-jewellery-design/",
  },
};
...
export const metadataNl: Metadata = {
  title: "Diamantaccenten sieradenontwerp",
  description: "Diamantaccenten sieradenontwerp - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/diamond-accents-jewellery-design/",
  },
};
...
export const metadataDe: Metadata = {
  title: "Schmuckdesign mit Diamantakzenten",
  description: "Schmuckdesign mit Diamantakzenten - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/diamond-accents-jewellery-design/",
  },
};
...
export const metadataIt: Metadata = {
  title: "Diamanti in risalto nel design di gioielli: stili chiave",
  description: "Scopri come i diamanti laterali o d'accento valorizzano una pietra centrale. Esplora le impostazioni comuni di pavimentazione, canale e polo. - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/it/blog/diamond-accents-jewellery-design/",
  },
};
  ...
  "@graph": [
    ...
    },
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 4, "name": "How Diamond Accents Affect a Jewellery Design", "item": "https://www.aureliaroyale.com/blog/diamond-accents-jewellery-design/" }
      ]
    },
    {
      "@type": "FAQPage",
...
export default async function Page({ searchParams }: { searchParams: Promise<{ locale?: string }> }) {
  ...
  const localeData = getBlogDataByLocale("diamond-accents-jewellery-design", locale);
      ...
      <section className="relative left-1/2 w-screen -translate-x-1/2 bg-[#e8e5dc] py-16">
        <div className="mx-auto max-w-4xl px-6 text-center">
          <span className="font-jost text-xs font-semibold uppercase tracking-[0.25em] text-gold">
            {locale === "it" ? "Guide all'Acquisto" : locale === "de" ? "Schmuckpflege und Wartung" : locale === "nl" ? "Sieradenonderhoud en Verzorging" : locale === "fr" ? "Pierres de couleur et diamants" : locale === "es" ? "Piedras de colores y diamantes" : "Coloured Stones and Diamonds"}
          </span>
