...
export const metadataEn: Metadata = {
  title: "Perfume Skincare Diamond Jewellery",
  description: "Perfume Skincare Diamond Jewellery",
  alternates: {
...
export const metadataEs: Metadata = {
  title: "Perfumes Cuidado de la piel Joyas con diamantes",
  description: "Perfumes Cuidado de la piel Joyas con diamantes - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/perfume-skincare-diamond-jewellery/",
  },
};

export const metadataFr: Metadata = {
  title: "Parfums Soins de la peau Bijoux en diamant",
  description: "Parfums Soins de la peau Bijoux en diamant - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/perfume-skincare-diamond-jewellery/",
  },
};
...
export const metadataNl: Metadata = {
  title: "Parfum huidverzorging diamanten sieraden",
  description: "Parfum huidverzorging diamanten sieraden - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/perfume-skincare-diamond-jewellery/",
  },
};
...
export const metadataDe: Metadata = {
  title: "Parfüm-Hautpflege-Diamantschmuck",
  description: "Parfüm-Hautpflege-Diamantschmuck - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/perfume-skincare-diamond-jewellery/",
  },
};
...
export const metadataIt: Metadata = {
  title: "Effetto del profumo e della cura della pelle sui vostri gioielli con diamanti",
  description: "Proteggi la brillantezza delle tue gemme. Scopri come lozioni, profumi e lacche per capelli formano una pellicola che ossida i gioielli e come pulirli. - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/it/blog/perfume-skincare-diamond-jewellery/",
  },
};
...
export default async function Page({ searchParams }: { searchParams: Promise<{ locale?: string }> }) {
  ...
  const localeData = getBlogDataByLocale("perfume-skincare-diamond-jewellery", locale);
