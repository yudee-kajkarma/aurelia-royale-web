...
export const metadataEn: Metadata = {
  title: "Buying Fine Jewellery As Gift",
  description: "Buying Fine Jewellery As Gift",
  alternates: {
...
export const metadataEs: Metadata = {
  title: "Comprar joyería fina como regalo",
  description: "Comprar joyería fina como regalo - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/buying-fine-jewellery-as-gift/",
  },
};

export const metadataFr: Metadata = {
  title: "Acheter des bijoux raffinés en cadeau",
  description: "Acheter des bijoux raffinés en cadeau - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/buying-fine-jewellery-as-gift/",
  },
};
...
export const metadataNl: Metadata = {
  title: "Fijne sieraden kopen als cadeau",
  description: "Fijne sieraden kopen als cadeau - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/buying-fine-jewellery-as-gift/",
  },
};
...
export const metadataDe: Metadata = {
  title: "Feinen Schmuck als Geschenk kaufen",
  description: "Feinen Schmuck als Geschenk kaufen - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/buying-fine-jewellery-as-gift/",
  },
};
...
export const metadataIt: Metadata = {
  title: "Acquistare gioielli pregiati come regalo: elenco di controllo completo",
  description: "Scegli gioielli pregiati come regalo con fiducia. Controlla le preferenze, le dimensioni, il metallo, lo stile e le politiche del negozio del destinatario. - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/it/blog/buying-fine-jewellery-as-gift/",
  },
};
...
export async function generateMetadata({ searchParams }: { searchParams: Promise<{ locale?: string }> }): Promise<Metadata> {
  ...
  const localeData = getBlogDataByLocale("buying-fine-jewellery-as-gift", locale);
...
export default async function BuyingFineJewelleryAsGiftPage({ searchParams }: { searchParams: Promise<{ locale?: string }> }) {
  const resolvedSearchParams = await searchParams;
  const locale = resolvedSearchParams.locale ?? "en";
  const localeData = getBlogDataByLocale("buying-fine-jewellery-as-gift", locale);
  const sections = localeData && localeData.length > 0 ? localeData : articleSections;
