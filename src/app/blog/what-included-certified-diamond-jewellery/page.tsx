...
export const metadataEn: Metadata = {
  title: "What Included Certified Diamond Jewellery",
  description: "What Included Certified Diamond Jewellery",
  alternates: {
...
export const metadataEs: Metadata = {
  title: "Qué incluye joyas con diamantes certificados",
  description: "Qué incluye joyas con diamantes certificados - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/what-included-certified-diamond-jewellery/",
  },
};

export const metadataFr: Metadata = {
  title: "Ce qui incluait les bijoux en diamant certifié",
  description: "Ce qui incluait les bijoux en diamant certifié - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/what-included-certified-diamond-jewellery/",
  },
};
...
export const metadataNl: Metadata = {
  title: "Wat omvatte gecertificeerde diamanten sieraden",
  description: "Wat omvatte gecertificeerde diamanten sieraden - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/what-included-certified-diamond-jewellery/",
  },
};
...
export const metadataDe: Metadata = {
  title: "Was beinhaltet zertifizierten Diamantschmuck?",
  description: "Was beinhaltet zertifizierten Diamantschmuck? - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/what-included-certified-diamond-jewellery/",
  },
};
...
export const metadataIt: Metadata = {
  title: "Cosa è incluso nei gioielli con diamanti certificati?",
  description: "Assicurati di ricevere tutta la documentazione ufficiale. Scopri il certificato del diamante, la valutazione dei gioielli, la garanzia e le politiche di cura. - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/it/blog/what-included-certified-diamond-jewellery/",
  },
};
...
export async function generateMetadata({ searchParams }: { searchParams: Promise<{ locale?: string }> }): Promise<Metadata> {
  ...
  const localeData = getBlogDataByLocale("what-included-certified-diamond-jewellery", locale);
...
export default async function WhatIncludedCertifiedDiamondJewelleryPage({ searchParams }: { searchParams: Promise<{ locale?: string }> }) {
  const resolvedSearchParams = await searchParams;
  const locale = resolvedSearchParams.locale ?? "en";
  const localeData = getBlogDataByLocale("what-included-certified-diamond-jewellery", locale);
  const sections = localeData && localeData.length > 0 ? localeData : articleSections;
