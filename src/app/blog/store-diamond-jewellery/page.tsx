...
export const metadataEn: Metadata = {
  title: "Store Diamond Jewellery",
  description: "Store Diamond Jewellery",
  alternates: {
...
export const metadataEs: Metadata = {
  title: "Tienda de joyería de diamantes",
  description: "Tienda de joyería de diamantes - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/store-diamond-jewellery/",
  },
};

export const metadataFr: Metadata = {
  title: "Magasiner des bijoux en diamant",
  description: "Magasiner des bijoux en diamant - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/store-diamond-jewellery/",
  },
};
...
export const metadataNl: Metadata = {
  title: "Bewaar diamanten sieraden",
  description: "Bewaar diamanten sieraden - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/store-diamond-jewellery/",
  },
};
...
export const metadataDe: Metadata = {
  title: "Bewahren Sie Diamantschmuck auf",
  description: "Bewahren Sie Diamantschmuck auf - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/store-diamond-jewellery/",
  },
};
...
export const metadataIt: Metadata = {
  title: "Come conservare i tuoi gioielli con diamanti in modo sicuro",
  description: "Evitare danni accidentali. Scopri le migliori pratiche per riporre orecchini e anelli in borse singole o scomparti imbottiti. - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/it/blog/store-diamond-jewellery/",
  },
};
...
export default async function Page({ searchParams }: { searchParams: Promise<{ locale?: string }> }) {
  ...
  const localeData = getBlogDataByLocale("store-diamond-jewellery", locale);
