...
export const metadataEn: Metadata = {
  title: "Certified Lab Grown Diamond Jewellery Meaning",
  description: "Certified Lab Grown Diamond Jewellery Meaning",
  alternates: {
...
export const metadataEs: Metadata = {
  title: "Significado de las joyas con diamantes cultivados en laboratorio certificados",
  description: "Significado de las joyas con diamantes cultivados en laboratorio certificados - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/certified-lab-grown-diamond-jewellery-meaning/",
  },
};

export const metadataFr: Metadata = {
  title: "Signification des bijoux en diamants cultivés en laboratoire certifiés",
  description: "Signification des bijoux en diamants cultivés en laboratoire certifiés - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/certified-lab-grown-diamond-jewellery-meaning/",
  },
};
...
export const metadataNl: Metadata = {
  title: "Gecertificeerde laboratorium-gegroeide diamanten sieraden Betekenis",
  description: "Gecertificeerde laboratorium-gegroeide diamanten sieraden Betekenis - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/certified-lab-grown-diamond-jewellery-meaning/",
  },
};
...
export const metadataDe: Metadata = {
  title: "Bedeutung von zertifiziertem, im Labor gezüchtetem Diamantschmuck",
  description: "Bedeutung von zertifiziertem, im Labor gezüchtetem Diamantschmuck - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/certified-lab-grown-diamond-jewellery-meaning/",
  },
};
...
export const metadataIt: Metadata = {
  title: "Cosa significa gioielleria con diamanti creata in laboratorio certificato?",
  description: "Comprendi la differenza tra un rapporto sui diamanti sciolti, una valutazione di gioielli e un certificato di prodotto finito e perché ciascuno di essi è importante. - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/it/blog/certified-lab-grown-diamond-jewellery-meaning/",
  },
};
...
export default async function Page({ searchParams }: { searchParams: Promise<{ locale?: string }> }) {
  ...
  const localeData = getBlogDataByLocale("certified-lab-grown-diamond-jewellery-meaning", locale);
