...
export const metadataEn: Metadata = {
  title: "How To Choose Lab Grown Diamond Pendant",
  description: "How To Choose Lab Grown Diamond Pendant",
  alternates: {
...
export const metadataEs: Metadata = {
  title: "Cómo elegir un colgante de diamantes cultivados en laboratorio",
  description: "Cómo elegir un colgante de diamantes cultivados en laboratorio - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/how-to-choose-lab-grown-diamond-pendant/",
  },
};

export const metadataFr: Metadata = {
  title: "Comment choisir un pendentif en diamant cultivé en laboratoire",
  description: "Comment choisir un pendentif en diamant cultivé en laboratoire - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/how-to-choose-lab-grown-diamond-pendant/",
  },
};
...
export const metadataNl: Metadata = {
  title: "Hoe u een Lab Grown diamanten hanger kiest",
  description: "Hoe u een Lab Grown diamanten hanger kiest - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/how-to-choose-lab-grown-diamond-pendant/",
  },
};
...
export const metadataDe: Metadata = {
  title: "So wählen Sie einen im Labor gezüchteten Diamantanhänger aus",
  description: "So wählen Sie einen im Labor gezüchteten Diamantanhänger aus - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/how-to-choose-lab-grown-diamond-pendant/",
  },
};
...
export const metadataIt: Metadata = {
  title: "Come scegliere un ciondolo con diamante creato in laboratorio",
  description: "Trova una sospensione classica e versatile. Confronta solitari, aureole e design a tre pietre, valutando la tipologia di bracciale e catena. - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/it/blog/how-to-choose-lab-grown-diamond-pendant/",
  },
};
...
export async function generateMetadata({ searchParams }: { searchParams: Promise<{ locale?: string }> }): Promise<Metadata> {
  ...
  const localeData = getBlogDataByLocale("how-to-choose-lab-grown-diamond-pendant", locale);
...
export default async function HowToChooseLabGrownDiamondPendantPage({ searchParams }: { searchParams: Promise<{ locale?: string }> }) {
  const resolvedSearchParams = await searchParams;
  const locale = resolvedSearchParams.locale ?? "en";
  const localeData = getBlogDataByLocale("how-to-choose-lab-grown-diamond-pendant", locale);
  const sections = localeData && localeData.length > 0 ? localeData : articleSections;
