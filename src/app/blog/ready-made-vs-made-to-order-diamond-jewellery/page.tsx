...
export const metadataEn: Metadata = {
  ...
  description: "Ready Made Vs Made To Order Diamond Jewellery",
  alternates: {
...
export const metadataEs: Metadata = {
  title: "Joyas de diamantes confeccionadas o hechas por encargo",
  description: "Joyas de diamantes confeccionadas o hechas por encargo - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/ready-made-vs-made-to-order-diamond-jewellery/",
  },
};

export const metadataFr: Metadata = {
  title: "Bijoux en diamant prêts à l'emploi ou sur commande",
  description: "Bijoux en diamant prêts à l'emploi ou sur commande - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/ready-made-vs-made-to-order-diamond-jewellery/",
  },
};
...
export const metadataNl: Metadata = {
  title: "Kant-en-klaar versus op bestelling gemaakt diamanten sieraden",
  description: "Kant-en-klaar versus op bestelling gemaakt diamanten sieraden - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/ready-made-vs-made-to-order-diamond-jewellery/",
  },
};
...
export const metadataDe: Metadata = {
  title: "Fertiger oder auf Bestellung gefertigter Diamantschmuck",
  description: "Fertiger oder auf Bestellung gefertigter Diamantschmuck - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/de/blog/ready-made-vs-made-to-order-diamond-jewellery/",
  },
};
...
export const metadataIt: Metadata = {
  title: "Gioielli con diamanti ready-to-wear e gioielli su ordinazione",
  description: "Confronta i vantaggi di consegna e personalizzazione. Decidi se acquistare un pezzo in stock pronto per la spedizione o un design personalizzato realizzato per te. - Aurelia Royale",
  alternates: {
    canonical: "https://www.aureliaroyale.com/it/blog/ready-made-vs-made-to-order-diamond-jewellery/",
  },
};
...
export async function generateMetadata({ searchParams }: { searchParams: Promise<{ locale?: string }> }): Promise<Metadata> {
  ...
  const localeData = getBlogDataByLocale("ready-made-vs-made-to-order-diamond-jewellery", locale);
...
export default async function ReadyMadeVsMadeToOrderPage({ searchParams }: { searchParams: Promise<{ locale?: string }> }) {
  const resolvedSearchParams = await searchParams;
  const locale = resolvedSearchParams.locale ?? "en";
  const localeData = getBlogDataByLocale("ready-made-vs-made-to-order-diamond-jewellery", locale);
  const sections = localeData && localeData.length > 0 ? localeData : articleSections;
