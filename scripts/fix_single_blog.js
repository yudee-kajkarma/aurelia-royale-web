...
const file = path.join(__dirname, '..', 'src', 'app', 'blog', 'what-makes-lab-grown-diamonds-different', 'page.tsx');
let content = fs.readFileSync(file, 'utf8');

const fullCleanPage = `import { getBlogDataEs } from "@/utils/getBlogDataEs";
...
fs.writeFileSync(file, fullCleanPage, 'utf8');
console.log("CLEAN PAGE SAVED SUCCESSFULLY!");
